...
urlpatterns = [
    ...
    path(
        "products/product_variations/add_product_variation/",
        add_product_variation,
        name="add_product_variation",
    ),
    path(
        "products/product_variations/<int:id>/edit_variation",
        edit_product_variation,
        name="edit_product_variation",
    ),
    path(
        "products/product_variations/<int:id>/delete_variation",
        delete_product_variation,
    ...
    path(
        "excel_report/<str:start_date>//<str:end_date>/",
        excel_report,
        name="excel_report",
    ),
